  ...
  Column(
    ...
    ExposedDropdownMenuBox(
        ...
        OutlinedTextField(
            ...
            placeholder = {
                Text(
                    text = stringResource(R.string.hint_breed)
                )
            },
            label = {
                Text(
        ...
        ExposedDropdownMenu(
            ...
            Breed.entries.forEach { breed ->
                DropdownMenuItem(
                    text = { Text(text = stringResource(breed.translatedName))},
                    onClick = {
    ...
    OutlinedTextField(
      ...
      placeholder = {
        Text(
          text = stringResource(R.string.hint_age)
        )
      },
      label = {
        Text(
    ...
    OutlinedTextField(
      ...
      placeholder = {
        Text(
          text = stringResource(R.string.hint_weight)
        )
      },
      label = {
        Text(
    ...
    OutlinedTextField(
      ...
      placeholder = {
        Text(
          text = stringResource(R.string.hint_height)
        )
      },
      label = {
        Text(
